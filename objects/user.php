...
class User
{
    ...
    {
    // выбираем все записи
    $query = "SELECT u.first_name, u.last_name, u.email, u.phone, u_c.date_start, u_c.date_end, c.model as car_model
    FROM cars as c, users as u, users_cars as u_c
    WHERE c.id = u_c.cars_id AND u.id = u_c.users_id " ;
